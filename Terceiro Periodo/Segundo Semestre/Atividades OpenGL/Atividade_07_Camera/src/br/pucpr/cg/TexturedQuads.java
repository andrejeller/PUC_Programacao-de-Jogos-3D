...
public class TexturedQuads implements Scene {
    ...
    public void init() {
        ...
        light = new DirectionalLight(
                new Vector3f( 0.1f, 0.1f, 0.1f),    //direction
                new Vector3f( 1.0f,  1.0f,  0.0f), //ambient
                new Vector3f( 1.0f,  1.0f,  1.0f),    //diffuse
                new Vector3f( 1.0f,  1.0f,  1.0f)     //specular
        );
        try{
            mesh = MeshFactory.loadTerrain(new File("C:\\Users\\andrejeller\\Desktop\\PUC\\Programação 3D\\img\\opengl\\heights\\dog.jpg"), 0.5f);
        }catch (IOException e){
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        new Window(new TexturedQuads(), "Textures", 600, 600).show();
    }
}
